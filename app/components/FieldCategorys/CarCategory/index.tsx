        ...
        <div className="flex flex-col gap-5 ">
          ...
          <div className="flex flex-col lg:flex-row gap-5 justify-center items-center">
            <div className="flex flex-col lg:flex-row gap-2 ">
              ...
              <div className="">
                <select
                  data-te-select-init
                  className="border-[#EBEBEB] border-2 rounded-[8px] text-[#444] w-full lg:w-[210px] h-[52px] px-2"
                >
              ...
              <div className="flex">
                <button className="w-full lg:w-[192px] h-[52px] border-2 border-[#EBEBEB] rounded-[8px] text-[#444]">
                  Variant
                </button>
              </div>
              <div className="flex items-center justify-center gap-1 w-full lg:w-[185px] bg-primary text-[#FFFFFF] h-[52px] rounded-[8px]">
          ...
          <div className="flex flex-col lg:flex-row gap-5 justify-center items-center">
            <div className="flex flex-col lg:flex-row gap-2">
              ...
              <div className="flex justify-between items-center px-4 w-full lg:w-[154px] h-[52px] border-[#EBEBEB] border-2 rounded-[8px]">
              ...
              <div className="">
                <select
                  data-te-select-init
                  className="border-[#EBEBEB] border-2 rounded-[8px] text-[#444] w-full lg:w-[146px] h-[52px] px-2"
                >
              ...
              <div className="">
                <select
                  data-te-select-init
                  className="border-[#EBEBEB] border-2 rounded-[8px] text-[#444] w-full lg:w-[187px] h-[52px] px-2"
                >
          ...
          <div className="flex flex-col lg:flex-row gap-5 justify-center items-center">
            <div className="flex flex-col lg:flex-row gap-2 justify-center items-center">
              ...
              <div className="w-full lg:w-[187px] h-[52px] border-2 border-[#EBEBEB] rounded-[8px] text-[#444] flex items-center">
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <div className="flex gap-2 flex-wrap lg:flex-nowrap">
                  <div className="relative inline-block text-left">
                    ...
                    {/* Dropdown content */}
                    {isFrom && (
                      <div className="absolute mt-2 w-[195px] lg:w-[126px] bg-[#ffffff] text-primary rounded-[8px] border-2 border-[#EBEBEB]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <div className="relative inline-block text-left">
                    ...
                    {/* Dropdown content */}
                    {isVehicle && (
                      <div className="absolute mt-2 w-full lg:w-[126px] bg-[#ffffff] text-primary rounded-[8px] border-2 border-[#EBEBEB]">
                        <div className="px-3 py-2">Item 1</div>
                        <div className="px-3 py-2">Item 2</div>
                        <div className="px-3 py-2">Item 3</div>
                      </div>
